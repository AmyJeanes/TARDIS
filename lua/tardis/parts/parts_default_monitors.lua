...
if SERVER then
    ...
    function PART:MoveDown(ply)
        ...
        self:PlaySound({ path = "p00gie/tardis/default/monitor_move_vert.ogg" })
    ...
    function PART:Flip(ply)
        ...
        self:PlaySound({ path = "p00gie/tardis/default/monitor_flip.ogg" })
        self:RequestHitboxUpdate(ply)
    end
    ...
    function PART:RotateToEyePos(ply)
        ...
        if not ply then
            if IsValid(prev) then
                self:PlaySound({ path = "p00gie/tardis/default/monitor_release.ogg" })
            end
        ...
        self:PlaySound({ path = "p00gie/tardis/default/monitor_hold.ogg" })
    end
