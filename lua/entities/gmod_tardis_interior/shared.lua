...
---@overload fun(self: gmod_tardis_interior, name: "AutolandToggled", id: string, func: fun(self: gmod_tardis_interior, on: boolean, ...))
...
---@overload fun(self: gmod_tardis_interior, name: "CanToggleAutoland", id: string, func: fun(self: gmod_tardis_interior, force: boolean?, ...))
...
---@overload fun(self: gmod_tardis_interior, name: "CanTrack", id: string, func: fun(self: gmod_tardis_interior, ent: Entity|Player|gmod_tardis|gmod_tardis_part, ply: Player, ...))
...
---@overload fun(self: gmod_tardis_interior, name: "MatStart", id: string, func: fun(self: gmod_tardis_interior, ...))
...
---@overload fun(self: gmod_tardis_interior, name: "NoVortexMatCancelled", id: string, func: fun(self: gmod_tardis_interior, ...))
