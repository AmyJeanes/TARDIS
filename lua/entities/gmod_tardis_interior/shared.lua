...
---@overload fun(self: gmod_tardis_interior, name: "ShouldDrawBlackScreen", id: string, func: fun(self: gmod_tardis_interior, arg1: ("pop"|string), ...))
...
---@overload fun(self: gmod_tardis_interior, name: "ShouldNotDrawScreen", id: string, func: fun(self: gmod_tardis_interior, arg1: ("pop"|string), ...))
