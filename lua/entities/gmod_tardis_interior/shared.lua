...
---@overload fun(self: gmod_tardis_interior, name: "CanChangeExterior", id: string, func: fun(self: gmod_tardis_interior, target: false|string, arg2: boolean, ...))
...
---@overload fun(self: gmod_tardis_interior, name: "CanTrack", id: string, func: fun(self: gmod_tardis_interior, ent: Entity|gmod_tardis_part, ply: Player, ...))
...
---@overload fun(self: gmod_tardis_interior, name: "CanUsePart", id: string, func: fun(self: gmod_tardis_interior, arg1: gmod_tardis_part, a: Entity|NULL, ...))
...
---@overload fun(self: gmod_tardis_interior, name: "PartUsed", id: string, func: fun(self: gmod_tardis_interior, arg1: gmod_tardis_part, a: Entity|NULL, ...))
