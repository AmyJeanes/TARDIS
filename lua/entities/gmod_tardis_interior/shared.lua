...
---@overload fun(self: gmod_tardis_interior, name: "AllowInteriorPos", id: string, func: fun(self: gmod_tardis_interior, arg1: any, saved_pos: any, arg3: Vector, arg4: Vector, ...))
