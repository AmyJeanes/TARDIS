...
E2Helper.Descriptions["tardisAutoland"] = "Toggles or sets autoland, returns 1 if success or 0 if failure."
...
E2Helper.Descriptions["tardisAutolandOn"] = "Returns 1 if autoland is enabled or 0 if autoland is disabled."
