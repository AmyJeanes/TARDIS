...
E2Helper.Descriptions["tardisAutoland"] = "Toggles or sets auto-land, returns 1 if success or 0 if failure."
...
E2Helper.Descriptions["tardisAutolandOn"] = "Returns 1 if auto-land is enabled or 0 if auto-land is disabled."
