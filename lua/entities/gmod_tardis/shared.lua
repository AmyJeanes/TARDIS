...
---@overload fun(self: gmod_tardis, name: "CanChangeExterior", id: string, func: fun(self: gmod_tardis, id: (false|string), retry: boolean?, ...))
---@overload fun(self: gmod_tardis, name: "CanChangePilot", id: string, func: fun(self: gmod_tardis, ply: Player, ...))
---@overload fun(self: gmod_tardis, name: "CanDemat", id: string, func: fun(self: gmod_tardis, arg1: boolean, arg2: boolean, ...))
...
---@overload fun(self: gmod_tardis, name: "ExteriorChanged", id: string, func: fun(self: gmod_tardis, id: (false|string), ...))
...
---@overload fun(self: gmod_tardis, name: "ShouldDrawBlackScreen", id: string, func: fun(self: gmod_tardis, arg1: ("pop"|integer|string), ...))
...
---@overload fun(self: gmod_tardis, name: "ShouldNotDrawScreen", id: string, func: fun(self: gmod_tardis, arg1: ("pop"|integer|string), ...))
...
---@overload fun(self: gmod_tardis, name: "ShouldNotRenderPortal", id: string, func: fun(self: gmod_tardis, arg1: gmod_tardis, portal: any, exit: any, origin: any, ...))
