...
---@overload fun(self: gmod_tardis, name: "ShouldDrawBlackScreen", id: string, func: fun(self: gmod_tardis, arg1: ("pop"|string), ...))
...
---@overload fun(self: gmod_tardis, name: "ShouldNotDrawScreen", id: string, func: fun(self: gmod_tardis, arg1: ("pop"|string), ...))
