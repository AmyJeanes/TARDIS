...
---@overload fun(self: gmod_tardis, name: "AutolandToggled", id: string, func: fun(self: gmod_tardis, on: boolean, ...))
...
---@overload fun(self: gmod_tardis, name: "CanToggleAutoland", id: string, func: fun(self: gmod_tardis, force: boolean?, ...))
...
---@overload fun(self: gmod_tardis, name: "CanTrack", id: string, func: fun(self: gmod_tardis, ent: Entity|Player|gmod_tardis|gmod_tardis_part, ply: Player, ...))
